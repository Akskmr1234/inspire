...
const en = {
  ...
  tax: {
    ...
    noInput: 'Nothing was posted to an input tax account in this period.',
    differenceHint:
    ...
    inputHint:
      'Input tax is read from postings to the accounts this firm maps to each head. There is no taxable value beside it: a posting records the tax, not the purchase it was charged on. That arrives with the purchase module.',
  },
  grid: {
...
const ar = {
  ...
  tax: {
    ...
    noInput: 'لم يُسجَّل أي قيد على حسابات ضريبة المدخلات في هذه الفترة.',
    differenceHint:
    ...
    inputHint:
      'تُقرأ ضريبة المدخلات من القيود على الحسابات التي ربطها هذا المنشأة بكل بند. ولا توجد قيمة خاضعة بجانبها: القيد يسجّل الضريبة لا المشتريات التي احتُسبت عليها. وتأتي مع وحدة المشتريات.',
  },
  grid: {
